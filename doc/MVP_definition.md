...
Le projet cible des joueurs d’arcade et des équipes pédagogiques qui veulent une expérience de playfield moderne, visuelle et interactive.  
...
- Contrôles jouables au clavier (playfields + lancement de bille).
...
- **Environnement** : dépendance à un réseau local stable et à la disponibilité ponctuelle du playfield physique.
